...
//COMMUNITIES
$labels = array(
    'name'                  => _x( 'Communities', 'Post Type General Name', 'wecpt' ),
    'singular_name'         => _x( 'Communitie', 'Post Type Singular Name', 'wecpt' ),
    'menu_name'             => __( 'Communities', 'wecpt' ),
    'name_admin_bar'        => __( 'Communities', 'wecpt' ),
...
$args = array(
    'label'                 => __( 'Communitie', 'wecpt' ),
    'description'           => __( 'Communities in UK, Ireland and abroad', 'wecpt' ),
    'labels'                => $labels,
