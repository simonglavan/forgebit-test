...
//REGIONS
$labels = array(
    'name'                  => _x( 'Regions', 'Post Type General Name', 'wecpt' ),
    'singular_name'         => _x( 'Region', 'Post Type Singular Name', 'wecpt' ),
    'menu_name'             => __( 'Regions', 'wecpt' ),
    'name_admin_bar'        => __( 'Regions', 'wecpt' ),
...
$args = array(
    'label'                 => __( 'Region', 'wecpt' ),
    'description'           => __( 'Regions', 'wecpt' ),
    'labels'                => $labels,
