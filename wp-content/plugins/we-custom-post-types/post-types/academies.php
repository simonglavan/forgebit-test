...
//ACADEMIES
$labels = array(
    'name'                  => _x( 'Academies', 'Post Type General Name', 'wecpt' ),
    'singular_name'         => _x( 'Academie', 'Post Type Singular Name', 'wecpt' ),
    'menu_name'             => __( 'Academies', 'wecpt' ),
    'name_admin_bar'        => __( 'Academies', 'wecpt' ),
...
$args = array(
    'label'                 => __( 'Academie', 'wecpt' ),
    'description'           => __( 'Academies in UK, Ireland and abroad', 'wecpt' ),
    'labels'                => $labels,
