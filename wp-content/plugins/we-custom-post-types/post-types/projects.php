...
//PROJECTS
$labels = array(
    'name'                  => _x( 'Projects', 'Post Type General Name', 'wecpt' ),
    'singular_name'         => _x( 'Project', 'Post Type Singular Name', 'wecpt' ),
    'menu_name'             => __( 'Projects', 'wecpt' ),
    'name_admin_bar'        => __( 'Projects', 'wecpt' ),
...
$args = array(
    'label'                 => __( 'Project', 'wecpt' ),
    'description'           => __( 'Projects in UK, Ireland and abroad', 'wecpt' ),
    'labels'                => $labels,
