...
//Implementations
$labels = array(
    'name'                  => _x( 'Implementations', 'Post Type General Name', 'wecpt' ),
    'singular_name'         => _x( 'Implementation', 'Post Type Singular Name', 'wecpt' ),
    'menu_name'             => __( 'Implementations', 'wecpt' ),
    'name_admin_bar'        => __( 'Implementations', 'wecpt' ),
...
$args = array(
    'label'                 => __( 'Implementation', 'wecpt' ),
    'description'           => __( 'Implementations in UK, Ireland and abroad', 'wecpt' ),
    'labels'                => $labels,
...
register_post_type( 'implementations', $args );
