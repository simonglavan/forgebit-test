...
//CITIES
$labels = array(
    'name'                  => _x( 'Cities', 'Post Type General Name', 'wecpt' ),
    'singular_name'         => _x( 'City', 'Post Type Singular Name', 'wecpt' ),
    'menu_name'             => __( 'Cities', 'wecpt' ),
    'name_admin_bar'        => __( 'Cities', 'wecpt' ),
...
$args = array(
    'label'                 => __( 'City', 'wecpt' ),
    'description'           => __( 'Cities in UK, Ireland and abroad', 'wecpt' ),
    'labels'                => $labels,
