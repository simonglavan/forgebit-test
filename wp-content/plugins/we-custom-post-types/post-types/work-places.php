...
//WORK PLACES
$labels = array(
    'name'                  => _x( 'Work places', 'Post Type General Name', 'wecpt' ),
    'singular_name'         => _x( 'Work place', 'Post Type Singular Name', 'wecpt' ),
    'menu_name'             => __( 'Work places', 'wecpt' ),
    'name_admin_bar'        => __( 'Work places', 'wecpt' ),
...
$args = array(
    'label'                 => __( 'Work place', 'wecpt' ),
    'description'           => __( 'Work places in UK, Ireland and abroad', 'wecpt' ),
    'labels'                => $labels,
